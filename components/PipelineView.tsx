        ...
        {COLUMNS.map((column) => {
          ...
          return (
            ...
            >
              ...
              <div className={`flex-1 min-h-[500px] bg-[#F4F4F5]/30 rounded-lg p-2 border border-transparent transition-all ${draggedLead ? 'border-dashed border-[#D4D4D4] bg-[#F4F4F5]/50' : ''
                }`}>
